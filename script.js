...
function getIcon(condition){
    if(condition === "Partly-cloudy-day"){
        return "icon/partial cloud.png";
    } else if(condition === "partily-cloud-night"){
...
function changeBackground(condition) {
    ...
    let bg = "";
    if(condition === "Partly-cloudy-day"){
        bg =  "icon/partial cloud.png";
    } else if(condition === "partily-cloud-night"){
        bg = "icons/night cloud moon.png";
    } else if(condition === "rain"){
        bg = "icons/rain.png";
    } else if(condition === "clear-day"){
        bg = "icons/sun (1).png";
    } else if(condition === "clear-night"){
        bg = "icons/cloudy-night.png";
    } else {
        bg = "icons/sun (1).png";
    }
    body.style.backgroundImage = `linear-gradiant(rgba(0,0,0,0.5), rgba(0,0,0,0.5), url(${bg}))`
}
